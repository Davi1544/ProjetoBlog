                ...
                <div class="col-md-10" style="padding-top: 50px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            'Desativar(1)' : 'Ativar(0)'; ?> </a></td>
                            <td><a href='core/usuario_repositorio.php?acao=adm&id=<?php echo $entidade ['id']?>&valor=<?php echo !$entidade ['adm']?>'><?php echo ($entidade ['adm']==1) ? 'Rebaixar(1)' : 
                            'Promover(0)'; ?> </a></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
